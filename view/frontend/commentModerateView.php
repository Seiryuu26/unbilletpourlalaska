...
<?= $comment['id'] ?>" method="post" enctype="multipart/form-data">
                ...
                <input value="<?= htmlspecialchars($comment['date']) ?>"> <a class=" btn btn-success"
                                                                             href="index.php?action=reability&amp;id=<?= htmlspecialchars($comment['id']) ?>">
                    désignaler </a>
                <br/>
                ...
                <div class="form-actions">
                    ...
                    <a class="btn btn-primary" href="index.php?action=board"><span
                                class="glyphicon glyphicon-arrow-left"> Retour</span></a><a class="btn btn-danger"
                                                                                            href="index.php?action=eraseComment&amp;id=
            ...
            <table>
                ...
                <TABLE BORDER="1">
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-primary" href="index.php?action=moderateComment&amp">mod&eacute;rer</a>
                        </td>
                    </tr>
                    <tr>
                        <th>commentaire2</th>
