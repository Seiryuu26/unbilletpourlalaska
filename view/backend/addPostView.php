    ...
    <div class="container admin add">
        ...
        <form action='index.php?action=addPost' method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name='chapter' placeholder="Chapter"> <span
                        class="help-inline"></span></div>
            <div class="form-group">
                <label for="description">Titre:</label>
                <input type="text" class="form-control" name='title' placeholder="Title"> <span
                        class="help-inline"></span></div>
            <div class="form-group">
                <label for="description">Contenu:</label>
                <textarea type="text" class="form-control" name='content' placeholder="Content"></textarea> <span
                        class="help-inline"></span></div>
            <br>
            <br>
            <div class="form-actions">
                <input type="submit" class="btn btn-success " value=" Ajouter"><a class="btn btn-primary"
                                                                                  href="index.php"><span
                            class="glyphicon glyphicon-arrow-left"> Retour</span></a></div>
        </form>
    </div>
    <script>
        tinymce.init({
